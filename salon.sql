...
INSERT INTO public.appointments VALUES (16, 1, 1, 'tommorow');
...
INSERT INTO public.customers VALUES (1, '833-6073', 'Mike');
INSERT INTO public.customers VALUES (2, '875-7147', 'Elvis');
...
SELECT pg_catalog.setval('public.appointments_appointments_id_seq', 22, true);
...
SELECT pg_catalog.setval('public.customers_customers_id_seq', 34, true);
...
SELECT pg_catalog.setval('public.services_services_id_seq', 1, false);
